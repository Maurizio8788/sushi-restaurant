...
function navClick(){
  ...
  return (
    ...
    <div>
    <nav className="flex items-center justify-between flex-row-reverse flex-wrap bg-pink-500 p-6">
...
<div>
   <a href="#" className="inline-block text-sm px-4 pb-2 leading-none text-white border-white hover:text-gray-300 mt-4 lg:mt-0"><i className='fas fa-search'></i></a>
</div>
